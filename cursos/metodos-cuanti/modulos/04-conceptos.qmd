...
> nota incluir parrafo o descipcion de problemas aritmenticos de agregacion. 
opciones aditivas, multiplicativas y variantes.
...
Una **variable** es cualquier característica de un objeto, actor o evento que puede asumir al menos dos valores o categorías, por oposicion a una **constante** que solo asume un valor o categoria. Decimos que algo se convierte en variable cuando pasa de ser una abstracción (“nivel educativo”) a una característica que podemos registrar de manera diferenciada (“años de escolaridad completados” o "maxima titulacion formal alcanzada"). Para que una variable esté bien definida debe cumplir con ciertos criterios básicos.  
...
> nota, agregar los tipos de validez, de constructo, etc.
...
> nota, en intervalo incluir algun otro ejemplo y definir el problema del ratio mas que la distancia solamente
...
Por último, entre las variables cuantitativas también es útil distinguir entre variables **discretas** y **continuas**. Las discretas son aquellas que se cuentan en números enteros: la cantidad de tratados internacionales firmados por un país, el número de guerras en un siglo, la cantidad de hijos de una persona. Las continuas, en cambio, pueden asumir cualquier valor dentro de un rango infinito: la altura, la edad o el gasto militar como porcentaje del PBI. Esta diferencia también condiciona los métodos estadísticos que resultan adecuados para analizarlas.  
